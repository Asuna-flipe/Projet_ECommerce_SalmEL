...
$woocommerce = new Client(
    ...
    'ck_183137d60531a760179a291710168970a0f0f18b',
    'cs_6b155b1b67b0e888aa4a5b364803231348641377',
    [
        'wp_api' => true,
        'version' => 'wc/v3',
...
try {
  ...
  /*  $sales = $woocommerce->get('reports/sales', $query);
    ...
    if (isset($_POST['btn-update'])) {
        ...
        header('Location: http://localhost:8088/ELAAKKOUCHI_Salma_woocommercePhPApp');
        }
